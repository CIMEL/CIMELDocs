...
c	FDATA='1267_20160503_2016061704071617'
	FDATA='525_20170526_2017123105031012'
C	TO CREATE INPUT FILE TITLE FOR AERONET INVERSION
c	存放参数文件以及数据文件主目录
     	FIPT='E:\CARSNET\AERONET_INVERSION\ins_para\'
c	存储AERONET反演算法所需输入输入文件的目录
cz      FOUT='g:\AERONET_INVERSION\input\'//trim(STNS_FN)//'\'//trim(STNS_ID
cz     &)//'\'
	FOUT='E:\CARSNET\AERONET_INVERSION\input\'//trim(STNS_FN)//'\' 
	FBRDF='E:\CARSNET\AERONET_INVERSION\modis_brdf\' 
	FDAT='E:\CARSNET\CIMEL_NETWORK\'
